...
def sign_up():
    if request.method == 'POST':
        ...
        flag = False
        for temp in temps:
            if user.email == temp.email or user.username == temp.username:
                flag = True
            else:
                pass

        if flag == True:
            some_text = 'Sorry, but this email or username already exist! Try again and change your email or username...'
